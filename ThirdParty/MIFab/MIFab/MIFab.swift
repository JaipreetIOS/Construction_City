...
public class MIFab {
    ...
    public struct Config {
        ...
        public var buttonPadding = CGSize(width: 16, height: 16)
    ...
    public init(hide : UIViewController , config: Config) {
...
//
        ...
        fabButtonSuperView.addConstraints([
            NSLayoutConstraint(item: fabButtonSuperView, attribute: .bottom, relatedBy: .equal, toItem: fabButton, attribute: .bottom, multiplier: 1, constant: 0),
            NSLayoutConstraint(item: fabButtonSuperView, attribute: .trailing, relatedBy: .equal, toItem: fabButton, attribute: .trailing, multiplier: 1, constant: 0)
            ])
